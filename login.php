...
<div class="container-fluid custom-bg">
            ...
            <div class="login-con">
                ...
                <!-- <form method="post" id="contact-form" autocomplete="off"> -->
                    <div class="form-group">
                        <label class="text-cu-1"><i class="far fa-envelope"></i> Username *</label>
                    ...
                    <div class="form-group">
                        <input type="submit" onclick="login()" class="my-btn" value="Login">
                        <!-- <div class="spinner-border text-light" role="status" id="loader"> -->
                            <!-- <span class="sr-only">Loading...</span> -->
                    </div>
                    <div class="form-group">
                       <p  style="font-size: 20px;color: white;">Don't have an account? <a href="signup.php"> Signup</a></p>
    ...
    function login()
    {
        var uname = document.getElementById("u_email").value;
        ...
        xhttp.onreadystatechange =function()
        {
            if(this.readyState == 4 && this.status == 200)
            {
                ...
                if(rs.success == true)
                {
                    ...
                    if(rs.type=="user")
                    {
                        window.location.href = 'http://localhost/course/profile.php';
                    }
                    else if(rs.type=="admin")
                    {
                        window.location.href = 'http://localhost/course/Admin/Dashboard.php';
                    }
                }
                else
                {
        ...
        xhttp.open("GET","ajax-process/login-verify.php?uname="+uname+"&pass="+pass,true);
        xhttp.send();
